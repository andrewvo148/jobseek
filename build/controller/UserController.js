...
var UserController = /** @class */ (function () {
    function UserController() {
        this.userRepository = new UserRepositoty_1.UserRepository();
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.userRepository.findOne(request.params.id)];
                    case 1:
                        user = _a.sent();
                        response.json(user);
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.userRepository.save(request.body)];
                    case 1:
                        user = _a.sent();
                        response.json(user);
                        return [3 /*break*/, 3];
